...
class CommandesController extends AbstractController
{
    ...
    /*    $panier=$session->getSession()->get("panier");
        ...
        foreach ($panier as $key => $value  ){ 
            ...
            $commande->setProduits($ProduitsRepository->find($key));
    ...
    /*    $panier=$session->getSession()->get("panier");
        ...
        $stripeSecretKey="sk_test_51NAuKZI1RU50trmvZqASIQ6Ig8PHaOJFi436FDEoSdyxsZ5GufbwmjYVig4yjd7aiUcBeaPzqdN5QCn8nxKp6Tw500NMQ1jCVd";
